...
using the bps BlackBerry Messenger Social Platform APIs and read and update the user's
BBM profile.
...
Note this sample does not have a GUI.  Output is sent to stdout.  		
...
BlackBerry Native SDK 10.0.09 or higher
BlackBerry 10 device running 10.0.09 OS or higher
