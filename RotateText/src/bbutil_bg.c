/*
 * Copyright (c) 2013 BGmot. This is original RIM's file with
 * added void bbutil_render_text_angle() function.
 *
...
#ifdef USING_GL20
void bbutil_render_text_angle(font_t* font, const char* msg, float x, float y, float r, float g, float b, float a, float angle) {
    int i, c;
    GLfloat *vertices;
    GLfloat *texture_coords;
    GLshort* indices;
